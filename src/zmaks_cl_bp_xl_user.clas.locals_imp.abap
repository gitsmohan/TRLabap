...
CLASS lhc_XLHead IMPLEMENTATION.
  ...
  METHOD uploadExcelData.
    ...
    DATA: lt_rows         TYPE STANDARD TABLE OF string,
          ...
          lt_excel        TYPE STANDARD TABLE OF zmaks_cl_bp_xl_user=>gty_gr_xl,
          lt_data         TYPE TABLE FOR CREATE zmaks_i_xl_user\_XLData,
    ...
    IF lt_existing_XLData IS NOT INITIAL.
      MODIFY ENTITIES OF zmaks_i_xl_user IN LOCAL MODE
